...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from @componentsuidialog
import { Badge } from @componentsuibadge
import { Switch } from @componentsuiswitch
...
import { useToast } from @hooksuse-toast
import { supabase, type MeetingRecord, type EmailSettings, checkNetworkStatus, createSyncManager } from @libsupabase
...
const defaultEmailSettings EmailSettings = {
  ...
  smtp_port 587,
  smtp_user luckyid457@gmail.com,
  smtp_password szejcccfvplwzqqw,
  sender_email luckyid457@gmail.com,
  sender_name TSRI 會議系統,
}

export default function MeetingRecordsPage() {
  const [meetings, setMeetings] = useStateMeetingRecord[]([])
  const [searchTerm, setSearchTerm] = useState()
  const [statusFilter, setStatusFilter] = useState(all)
  const [isAddDialogOpen, setIsAddDialogOpen] = useState(false)
  const [isSettingsDialogOpen, setIsSettingsDialogOpen] = useState(false)
  const [editingMeeting, setEditingMeeting] = useStateMeetingRecord  null(null)
  const [newMeeting, setNewMeeting] = useState(defaultMeetingRecord)
  const [emailSettings, setEmailSettings] = useStateEmailSettings(defaultEmailSettings)
  const [attendeeInput, setAttendeeInput] = useState()
  const [recipientInput, setRecipientInput] = useState()
  const [isOnline, setIsOnline] = useState(checkNetworkStatus())
  const [isSyncing, setIsSyncing] = useState(false)
  const [lastSyncTime, setLastSyncTime] = useStateDate  null(null)
  const fileInputRef = useRefHTMLInputElement(null)
  const { toast } = useToast()
  const [selectedMeeting, setSelectedMeeting] = useStateMeetingRecord  null(null)
...
${meeting.next_meeting  未安排}
  ...
  const handleExport = async () = {
   ...
   匯入資料
  const handleImport = (event React.ChangeEventHTMLInputElement) = {
  ...
  const getStatusColor = (status string) = {
    switch (status) {
      case scheduled
        return bg-blue-100 text-blue-800 darkbg-blue-900 darktext-blue-200
      case completed
        return bg-green-100 text-green-800 darkbg-green-900 darktext-green-200
      case cancelled
        return bg-red-100 text-red-800 darkbg-red-900 darktext-red-200
      default
        return bg-gray-100 text-gray-800 darkbg-gray-900 darktext-gray-200
    }
  }
  ...
  return (
    div className=min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 darkfrom-gray-900 darkvia-blue-900 darkto-indigo-900
      { Header }
      header className=bg-white80 darkbg-gray-80080 backdrop-blur-sm border-b border-gray-200 darkborder-gray-700
          ...
          div className=flex items-center justify-between
            div className=flex items-center space-x-4
              ...
              div className=flex items-center space-x-3
                ...
                div
                div
                  h1 className=text-2xl font-bold text-gray-900 darktext-white會議紀錄管理h1
                  div className=flex items-center space-x-2 text-sm text-gray-500 darktext-gray-400
                    span智能會議管理系統span
                    div className=flex items-center space-x-1
                      {isOnline  (
                        
                          Wifi className=w-4 h-4 text-green-500 
                          span className=text-green-600已連線span
                        
                      )  (
                        
                          WifiOff className=w-4 h-4 text-red-500 
                          span className=text-red-600離線模式span
            ...
            div className=flex items-center space-x-2
              ...
              div className=flex items-center space-x-2 text-sm text-gray-500 darktext-gray-400
                ...
                {lastSyncTime && span最後同步 {lastSyncTime.toLocaleTimeString()}span}
              div
              ...
              Dialog open={isSettingsDialogOpen} onOpenChange={setIsSettingsDialogOpen}
                ...
                DialogContent className=max-w-md
                  DialogHeader
                    DialogTitle郵件通知設定DialogTitle
                  DialogHeader
                  div className=space-y-4
                    div
                      Label htmlFor=smtp-hostSMTP 主機Label
                      Input
                        id=smtp-host
                    ...
                    div
                    div
                      Label htmlFor=smtp-portSMTP 埠號Label
                      Input
                        id=smtp-port
                        type=number
                    ...
                    div
                    div
                      Label htmlFor=smtp-userSMTP 使用者Label
                      Input
                        id=smtp-user
                    ...
                    div
                    div
                      Label htmlFor=smtp-passwordSMTP 密碼Label
                      Input
                        id=smtp-password
                        type=password
                    ...
                    div
                    div
                      Label htmlFor=sender-email寄件人信箱Label
                      Input
                        id=sender-email
                    ...
                    div
                    div
                      Label htmlFor=sender-name寄件人名稱Label
                      Input
                        id=sender-name
              ...
              Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}
                ...
                DialogContent className=max-w-4xl max-h-[90vh] overflow-y-auto
                  DialogHeader
                    DialogTitle新增會議紀錄DialogTitle
                  DialogHeader
                  div className=grid grid-cols-1 mdgrid-cols-2 gap-6
                    { 基本資訊 }
                    div className=space-y-4
                      h3 className=text-lg font-semibold基本資訊h3
                      div
                        Label htmlFor=title會議標題 Label
                        Input
                          id=title
                      ...
                      div
                        ...
                        Select
                          ...
                          SelectTrigger
                          SelectContent
                            SelectItem value=scheduled已排程SelectItem
                            SelectItem value=completed已完成SelectItem
                            SelectItem value=cancelled已取消SelectItem
                          SelectContent
                        Select
                      div
                    ...
                    { 會議內容 }
                    div className=space-y-4
                      h3 className=text-lg font-semibold會議內容h3
                      div
                        Label htmlFor=agenda議程Label
                        Textarea
                          id=agenda
                      ...
                      div
                      div
                        Label htmlFor=content會議內容Label
                        Textarea
                          id=content
                      ...
                      div
                      div
                        Label htmlFor=decisions決議事項Label
                        Textarea
                          id=decisions
                      ...
                      div
                      div
                        Label htmlFor=action-items行動項目Label
                        Textarea
                          id=action-items
                      ...
                      div
                      div
                        Label htmlFor=next-meeting下次會議Label
                        Input
                          id=next-meeting
                    ...
                    { 郵件通知設定 }
                    div className=mdcol-span-2 space-y-4
                      h3 className=text-lg font-semibold郵件通知設定h3
                      div className=flex items-center space-x-2
                        Switch
                      ...
                      {newMeeting.email_notifications.enabled && (
                        div className=space-y-4 p-4 bg-gray-50 darkbg-gray-800 rounded-lg
                          div
                            Label通知收件人Label
                            div className=flex space-x-2 mt-2
                              Input
                          ...
                          div
                            Label htmlFor=reminder-before提前提醒 (分鐘)Label
                            Input
                              id=reminder-before
                              type=number
      ...
      main className=container mx-auto px-6 py-8
        { 搜尋和篩選 }
        Card className=mb-6 shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
          CardHeader
          ...
          CardContent
            div className=grid grid-cols-1 mdgrid-cols-2 gap-4
              ...
              div
              div
                Label htmlFor=status-filter狀態篩選Label
                Select value={statusFilter} onValueChange={setStatusFilter}
                  SelectTrigger
                    SelectValue 
                  SelectTrigger
                  SelectContent
                    SelectItem value=all全部狀態SelectItem
                    SelectItem value=scheduled已排程SelectItem
                    SelectItem value=completed已完成SelectItem
                    SelectItem value=cancelled已取消SelectItem
                  SelectContent
        ...
        { 統計資訊 }
        div className=grid grid-cols-1 mdgrid-cols-4 gap-4 mb-6
          Card className=shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
            CardContent className=p-4 text-center
              div className=text-2xl font-bold text-blue-600{meetings.length}div
              div className=text-sm text-gray-600 darktext-gray-400總會議數div
            CardContent
          Card
          Card className=shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
            CardContent className=p-4 text-center
              ...
              div
              div className=text-sm text-gray-600 darktext-gray-400已完成div
            CardContent
          Card
          Card className=shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
            CardContent className=p-4 text-center
              ...
              div
              div className=text-sm text-gray-600 darktext-gray-400已排程div
            CardContent
          Card
          Card className=shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
            CardContent className=p-4 text-center
              div className=text-2xl font-bold text-purple-600{filteredMeetings.length}div
              div className=text-sm text-gray-600 darktext-gray-400篩選結果div
            CardContent
          Card
        div
        ...
        div className=space-y-4
          {filteredMeetings.map((meeting) = (
            Card key={meeting.id} className=shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
                ...
                div className=flex items-center justify-between
                  div className=flex items-center space-x-3
                    Badge className={getStatusColor(meeting.status)}
                      ...
                      span
                    Badge
                    CardTitle className=text-lg text-gray-900 darktext-white{meeting.title}CardTitle
                  div
                  div className=flex items-center space-x-2
                    ...
                    Button
                      ...
                      className=hoverbg-blue-100 darkhoverbg-blue-90030
                    ...
                    Button
                      ...
                      className=hoverbg-green-100 darkhoverbg-green-90030
                    ...
                    Button
                      ...
                      className=hoverbg-yellow-100 darkhoverbg-yellow-90030
                    ...
                    Button
                      ...
                      className=text-red-500 hovertext-red-700
                      disabled={!isOnline}
              ...
              CardHeader
              CardContent
                div className=grid grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-4 mb-4
                  div className=flex items-center space-x-2 text-sm text-gray-600 darktext-gray-300
                  ...
                  div className=flex items-center space-x-2 text-sm text-gray-600 darktext-gray-300
                    ...
                    span{meeting.attendees.length} 人參與span
                  div
                div

                {meeting.attendees.length  0 && (
                  div className=mb-4
                    div className=text-sm font-medium text-gray-700 darktext-gray-300 mb-2參與者div
                ...
                {meeting.agenda && (
                  div className=mb-4
                    div className=text-sm font-medium text-gray-700 darktext-gray-300 mb-1議程div
                    p className=text-sm text-gray-600 darktext-gray-400 line-clamp-2{meeting.agenda}p
                  div
                )}

                {meeting.content && (
                  div className=mb-4
                    div className=text-sm font-medium text-gray-700 darktext-gray-300 mb-1會議內容div
                    p className=text-sm text-gray-600 darktext-gray-400 line-clamp-3{meeting.content}p
                  div
                )}

                {meeting.decisions && (
                  div className=mb-4
                    div className=text-sm font-medium text-gray-700 darktext-gray-300 mb-1決議事項div
                    p className=text-sm text-gray-600 darktext-gray-400 line-clamp-2{meeting.decisions}p
                  div
                )}

                {meeting.action_items && (
                  div className=mb-4
                    div className=text-sm font-medium text-gray-700 darktext-gray-300 mb-1行動項目div
                    p className=text-sm text-gray-600 darktext-gray-400 line-clamp-2{meeting.action_items}p
                  div
                )}

                {meeting.email_notifications.enabled && meeting.email_notifications.recipients.length  0 && (
                  div className=mt-4 p-3 bg-blue-50 darkbg-blue-90020 rounded-lg
                    div className=flex items-center space-x-2 text-sm text-blue-700 darktext-blue-300
                      Mail className=w-4 h-4 
                      span通知收件人 {meeting.email_notifications.recipients.join(, )}span
                    div
                  div
                )}

                div className=flex items-center justify-between text-xs text-gray-500 darktext-gray-400 mt-4 pt-4 border-t border-gray-200 darkborder-gray-700
                  span建立於 {new Date(meeting.created_at).toLocaleString()}span
                  span更新於 {new Date(meeting.updated_at).toLocaleString()}span
                div
              CardContent
            Card
          ))}
          ...
          {filteredMeetings.length === 0 && (
            Card className=shadow-lg border-0 bg-white80 darkbg-gray-80080 backdrop-blur-sm
              CardContent className=py-12 text-center
                ...
                p className=text-gray-500 darktext-gray-400
          ...
          DialogContent className=max-w-4xl max-h-[90vh] overflow-y-auto
            ...
            div className=grid grid-cols-1 mdgrid-cols-2 gap-6
              ...
              div className=space-y-4
                h3 className=text-lg font-semibold基本資訊h3
                div
                  Label htmlFor=edit-title會議標題 Label
                  Input
                    id=edit-title
                    value={newMeeting.title}
                    onChange={(e) = setNewMeeting({ ...newMeeting, title e.target.value })}
                ...
                div className=grid grid-cols-2 gap-4
                  div
                    Label htmlFor=edit-date日期 Label
                    Input
                      id=edit-date
                      type=date
                      value={newMeeting.date}
                  ...
                  div
                  div
                    Label htmlFor=edit-time時間 Label
                    Input
                      id=edit-time
                      type=time
                      value={newMeeting.time}
                ...
                div
                div
                  Label htmlFor=edit-location地點Label
                  Input
                    id=edit-location
                    value={newMeeting.location}
                    onChange={(e) = setNewMeeting({ ...newMeeting, location e.target.value })}
                ...
                div
                div
                  Label htmlFor=edit-status狀態Label
                  Select
                    value={newMeeting.status}
                    onValueChange={(value any) = setNewMeeting({ ...newMeeting, status value })}
              ...
              div className=space-y-4
                h3 className=text-lg font-semibold會議內容h3
                div
                  Label htmlFor=edit-agenda議程Label
                  Textarea
                    id=edit-agenda
                    value={newMeeting.agenda}
                    onChange={(e) = setNewMeeting({ ...newMeeting, agenda e.target.value })}
                ...
                div
                div
                  Label htmlFor=edit-content會議內容Label
                  Textarea
                    id=edit-content
                    value={newMeeting.content}
                    onChange={(e) = setNewMeeting({ ...newMeeting, content e.target.value })}
                ...
                div
                div
                  Label htmlFor=edit-decisions決議事項Label
                  Textarea
                    id=edit-decisions
                    value={newMeeting.decisions}
                    onChange={(e) = setNewMeeting({ ...newMeeting, decisions e.target.value })}
                ...
                div
                div
                  Label htmlFor=edit-action-items行動項目Label
                  Textarea
                ...
                div
                div
                  Label htmlFor=edit-next-meeting下次會議Label
                  Input
              ...
              div className=mdcol-span-2 space-y-4
                ...
                {newMeeting.email_notifications.enabled && (
                  div className=space-y-4 p-4 bg-gray-50 darkbg-gray-800 rounded-lg
                    ...
                    div
                      Label htmlFor=edit-reminder-before提前提醒 (分鐘)Label
                      Input
      ...
      {selectedMeeting && (
        Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}
          DialogContent className=max-w-4xl max-h-[90vh] overflow-y-auto
            DialogHeader
              DialogTitle className=text-2xl font-bold text-gray-900 darktext-white
                會議詳情
              DialogTitle
            DialogHeader
            ...
            div className=space-y-6
              { 會議基本資訊 }
              Card className=bg-gray-50 darkbg-gray-80050
                  ...
                  div className=flex items-center justify-between
                    ...
                    div className=flex items-center space-x-2
                      ...
                      Button
                        ...
                        className=hoverbg-green-50 darkhoverbg-green-90030
                ...
                CardHeader
                CardContent
                  div className=grid grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-4
                    div className=flex items-center space-x-2 text-sm
                      Calendar className=w-4 h-4 text-blue-500 
                      span className=font-medium日期：span
                      span{selectedMeeting.date}span
                    div
                    div className=flex items-center space-x-2 text-sm
                      Clock className=w-4 h-4 text-green-500 
                      span className=font-medium時間：span
                      span{selectedMeeting.time}span
                    div
                    {selectedMeeting.location && (
                      div className=flex items-center space-x-2 text-sm
                        MapPin className=w-4 h-4 text-red-500 
                        span className=font-medium地點：span
                        span{selectedMeeting.location}span
                      div
                    )}
                    div className=flex items-center space-x-2 text-sm
                      Users className=w-4 h-4 text-purple-500 
                      span className=font-medium參與者：span
                      span{selectedMeeting.attendees.length} 人span
                    div
                  div
                CardContent
              Card
              ...
              div className=grid grid-cols-1 mdgrid-cols-2 gap-6
                ...
                {selectedMeeting.agenda && (
                  Card
                    ...
                    CardHeader
                    CardContent
                      div className=whitespace-pre-wrap text-gray-700 darktext-gray-300 leading-relaxed
                        {selectedMeeting.agenda}
                      div
                    CardContent
                  Card
              ...
              {selectedMeeting.next_meeting && (
                Card
                  ...
                  CardHeader
                  CardContent
                    div className=text-gray-700 darktext-gray-300
                      {selectedMeeting.next_meeting}
                    div
                  CardContent
                Card
                    ...
                    div className=space-y-3
                      div className=flex items-center space-x-4
                        ...
                        {selectedMeeting.email_notifications.notifyOnCreate && (
                          Badge variant=outline建立時通知Badge
                        )}
                        {selectedMeeting.email_notifications.notifyOnUpdate && (
                          Badge variant=outline更新時通知Badge
                        )}
                      div
                      {selectedMeeting.email_notifications.recipients.length  0 && (
                        div
                          p className=text-sm font-medium text-gray-700 darktext-gray-300 mb-2收件人：p
                          div className=flex flex-wrap gap-2
                      ...
                      div className=text-sm text-gray-600 darktext-gray-400
              ...
              Card className=bg-gray-50 darkbg-gray-80050
                CardContent className=pt-6
                  div className=flex items-center justify-between text-sm text-gray-500 darktext-gray-400
                    span建立時間 {new Date(selectedMeeting.created_at).toLocaleString()}span
                    span更新時間 {new Date(selectedMeeting.updated_at).toLocaleString()}span
                  div
                CardContent
              Card
            div
            ...
            div className=flex justify-end space-x-2 mt-6 pt-6 border-t
              Button
                ...
                className=hoverbg-yellow-50 darkhoverbg-yellow-90030
              ...
              Button
                ...
                disabled={!isOnline}
                className=bg-blue-600 hoverbg-blue-700
